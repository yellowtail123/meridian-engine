...
function _updatePL(){const lt=document.documentElement.classList.contains('light');PL.paper_bgcolor=lt?'#FFFFFF':'#272536';PL.plot_bgcolor=lt?'#E9E5DE':'#302E40';PL.font={family:'Inconsolata,monospace',color:lt?'#4A3F32':'#A99D91',size:12};PL.xaxis={gridcolor:lt?'rgba(80,60,20,.10)':'rgba(201,149,107,.06)'};PL.yaxis={gridcolor:lt?'rgba(80,60,20,.10)':'rgba(201,149,107,.06)'}}
