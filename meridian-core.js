...
const S={litR:[],oaF:false,wsD:[],wsC:[],wsCT:{},cT:'scatter',xC:'',yC:[],zC:'',envSel:new Set(['sst','chlor','wh','at']),envR:{},envTS:{},envTS2:{},lib:[],chatM:[],chatL:false,apiK:"",aiProvider:'anthropic',cols:{},activeCol:'',libSort:'recent',libStatusFilter:'all',batchMode:false,batchSelected:new Set(),skillLevel:safeParse('meridian_skill','intermediate'),envProvenance:{},activeProject:safeParse('meridian_active_project','Default')||'Default'};
const CL=['#C9956B','#7B9E87','#9B8EC4','#C27878','#D4A04A','#6BA3C9','#C96BA3','#8EC49B'];
let PL={paper_bgcolor:'#272536',plot_bgcolor:'#302E40',font:{family:'JetBrains Mono,monospace',color:'#A99D91',size:12},xaxis:{gridcolor:'rgba(201,149,107,.06)'},yaxis:{gridcolor:'rgba(201,149,107,.06)'},margin:{l:55,r:20,t:40,b:45},legend:{bgcolor:'transparent',font:{size:11}},colorway:CL};
function _updatePL(){const lt=document.documentElement.classList.contains('light');PL.paper_bgcolor=lt?'#FFFFFF':'#272536';PL.plot_bgcolor=lt?'#EDE9E3':'#302E40';PL.font={family:'JetBrains Mono,monospace',color:lt?'#5A4E3E':'#A99D91',size:12};PL.xaxis={gridcolor:lt?'rgba(139,105,20,.08)':'rgba(201,149,107,.06)'};PL.yaxis={gridcolor:lt?'rgba(139,105,20,.08)':'rgba(201,149,107,.06)'}}
